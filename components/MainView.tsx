    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-start justify-between">
          <h3
            className="font-medium text-slate-800 truncate text-sm flex-1"
            title={file.name}
          >
            {file.name}
          </h3>
    ...
    >
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between shadow-sm">
        <div className="flex items-center space-x-2 text-lg text-slate-600">
          ...
          {currentView === "my-drive" && currentFolderId && (
            ...
            <>
              {isCreatingFolder ? (
                <form
                  ...
                  className="flex items-center space-x-2 bg-slate-100 rounded-lg p-1 border border-slate-200 animate-in fade-in slide-in-from-right-4 duration-200"
                >
                  <input
                    type="text"
                    value={newFolderName}
                  ...
                  <button
                    type="submit"
                    className="p-1 hover:bg-white rounded-md text-green-600 transition-colors shadow-sm"
                  >
                    <Check size={16} />
                  </button>
                  <button
                    ...
                    className="p-1 hover:bg-white rounded-md text-red-500 transition-colors shadow-sm"
                  >
                    <X size={16} />
                  </button>
                </form>
                  ...
                  {filteredFolders.map((folder) => (
                    ...
                    >
                      <div className="flex items-center space-x-3 overflow-hidden">
                        <Folder
                          className="text-indigo-400 group-hover:text-indigo-600 fill-current flex-shrink-0"
                          size={24}
                        />
                      ...
                      <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        {currentView === "trash" && (
                          <button
                            onClick={(e) =>
                              handleRestore(e, folder.id, "folder")
                            }
